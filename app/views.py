...
def bank_upload(file_path):
    a = 'C:\\Users\\H.P\\Desktop\\74de6\\moon\\Scripts\\project5\\Bank.csv'
...
def branch_upload(file_path):
    b = 'C:\\Users\\H.P\\Desktop\\74de6\\moon\\Scripts\\project5\\branch1.csv'
    ...
    with open(b, 'r') as file:
        ...
        return HttpResponse('Branches are inserted successfully')
